...
****************************************/
	...
	function update($tabela, array $datas, $where){
		...
		$stUpdate = mysql_query($qrUpdate) or die ('Erro ao atualiar em: '.$tabela.' '.mysql_error());
