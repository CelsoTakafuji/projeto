...
if(function_exists(getUser)){
	if(!getUser($_SESSION['autUser']['id'],'1')){
		...
		$urlpai = $_GET['idpai'];
		$prefix = $_GET['uri'];
		$readPai = read('up_cats',"WHERE id = '$urlpai'");
		if(!$readPai){
...
<div class="bloco form" style="display:block">
	<div class="titulo">
		Criar sub categoria para <strong style="color:#900"><?php echo $catPai['nome']; ?></strong>
	...
	<?php
		if(isset($_POST['sendForm'])){
			...
			if(in_array('',$f)){
				...
				$_SESSION['cadastro'] = '<span class="ms ok">Categoria criada com sucesso! Você pode continar a editá-la aqui!</span>';
				header('Location: index2.php?exe=posts/categorias-edit&edit='.$idLast.'&url='.$prefix);
			}
		}
	?>
